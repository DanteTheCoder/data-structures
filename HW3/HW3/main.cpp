...
int main (int argc, const char * argv[]) {
    ...
    cout << "FILLED RATIO: " << averageFilledRatio << endl;*/
        ...
        std::cout<<employeeTable.findEmployee("01197108667").getSsn() << employeeTable.findEmployee("01197108667").getName() <<  std::endl;


        Employee emp("Ali",5,"Ankara","12345678900");
        employeeTable.addEntry(emp);

        std::cout << employeeTable.findEmployee("12345678900").getSsn()<< std::endl;
